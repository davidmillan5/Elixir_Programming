defmodule Writer do
  ...
  ## Parameters
  - `employee`: An Company.Employee struct to be written
  ...
  ## Examples
      iex> employee = Company.Employee.new("Jane Doe", "Manager")
  ...
  ## Examples
      iex> employees = [%Company.Employee{id: 1, ...}, %Company.Employee{id: 2, ...}]
